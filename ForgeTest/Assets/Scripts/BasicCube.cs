...
public class BasicCube : NetworkCubeBehavior
{
    /// <summary> 
    ...
    private void Update()
    {        // If we are not the owner of this network object then we should        // move this cube to the position/rotation dictated by the owner       
